...
- `#minor` — additive change to the public surface (new route, new schema field with default, new optional CLI flag)
- `#major` — breaking signature or wire-format change
