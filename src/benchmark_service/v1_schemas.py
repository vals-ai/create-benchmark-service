"""Lab-facing /v1/ task-listing schemas.

Evaluation and final scoring use the internal `/evaluate-response/` and
`/final-score/` endpoints directly. The remaining `/v1/` surface exposes
dataset task discovery for external orchestration.
"""
