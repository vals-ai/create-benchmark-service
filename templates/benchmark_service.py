...
from benchmark_service.sandbox import Sandbox, SandboxFile
...
class ExampleBenchmark(BenchmarkService):
    ...
    async def setup_task(self, task_id: str, sandbox: Sandbox, dataset: str | None = None) -> AsyncGenerator[StreamChunk, None]:
        ...
        await sandbox.upload_file(SandboxFile(content=problem_statement.encode(), remote_path="/tmp/problem_statement.txt"))
